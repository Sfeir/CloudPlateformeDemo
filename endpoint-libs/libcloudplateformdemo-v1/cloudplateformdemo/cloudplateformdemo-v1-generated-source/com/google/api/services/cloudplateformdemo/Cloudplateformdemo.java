...
public class Cloudplateformdemo extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "cloudplateformdemo/v1/";
   ...
   * @since 1.7
   */
  public Cloudplateformdemo(com.google.api.client.http.HttpTransport transport, com.google.api.client.json.JsonFactory jsonFactory,
   ...
   */
  Cloudplateformdemo(Builder builder) {
    super(builder);
  }
   ...
   * optional parameters, call the {@link TitlesAllTitles#execute()} method to invoke the remote
   * operation.
   *
   * @return the request
   */
  ...
  public class TitlesAllTitles extends CloudplateformdemoRequest<com.google.api.services.cloudplateformdemo.model.TitleCollection> {
     ...
     * any optional parameters, call the {@link TitlesAllTitles#execute()} method to invoke the remote
     * operation. <p> {@link TitlesAllTitles#initialize(com.google.api.client.googleapis.services.Abst
    ...
    protected TitlesAllTitles() {
      super(Cloudplateformdemo.this, "GET", REST_PATH, null, com.google.api.services.cloudplateformdemo.model.TitleCollection.class);
    }
   ...
   *
   * This request holds the parameters needed by the the cloudplateformdemo server.  After setting any
   * optional parameters, call the {@link TitlesCreateTitle#execute()} method to invoke the remote
   * operation.
   *
   * @param id
   * @param content the {@link com.google.api.services.cloudplateformdemo.model.Title}
   * @return the request
   */
  public TitlesCreateTitle titlesCreateTitle(java.lang.String id, com.google.api.services.cloudplateformdemo.model.Title content) throws java.io.IOException {
    TitlesCreateTitle result = new TitlesCreateTitle(id, content);
    initialize(result);
    return result;
  }

  public class TitlesCreateTitle extends CloudplateformdemoRequest<com.google.api.services.cloudplateformdemo.model.Title> {
     ...
     *
     * This request holds the parameters needed by the the cloudplateformdemo server.  After setting
     * any optional parameters, call the {@link TitlesCreateTitle#execute()} method to invoke the
     * remote operation. <p> {@link TitlesCreateTitle#initialize(com.google.api.client.googleapis.serv
     ...
     * @since 1.13
     */
    protected TitlesCreateTitle(java.lang.String id, com.google.api.services.cloudplateformdemo.model.Title content) {
      super(Cloudplateformdemo.this, "POST", REST_PATH, content, com.google.api.services.cloudplateformdemo.model.Title.class);
   ...
   *
   * This request holds the parameters needed by the the cloudplateformdemo server.  After setting any
   * optional parameters, call the {@link TitlesGetTitleById#execute()} method to invoke the remote
   * operation.
   *
   * @param id
   * @return the request
  ...
  public class TitlesGetTitleById extends CloudplateformdemoRequest<com.google.api.services.cloudplateformdemo.model.Title> {
     ...
     *
     * This request holds the parameters needed by the the cloudplateformdemo server.  After setting
     * any optional parameters, call the {@link TitlesGetTitleById#execute()} method to invoke the
     * remote operation. <p> {@link TitlesGetTitleById#initialize(com.google.api.client.googleapis.ser
   ...
   *
   * This request holds the parameters needed by the the cloudplateformdemo server.  After setting any
   * optional parameters, call the {@link TitlesUpdateTitleById#execute()} method to invoke the remote
   * operation.
   *
   * @param id
   * @param content the {@link com.google.api.services.cloudplateformdemo.model.Title}
   * @return the request
   */
  public TitlesUpdateTitleById titlesUpdateTitleById(java.lang.String id, com.google.api.services.cloudplateformdemo.model.Title content) throws java.io.IOException {
    TitlesUpdateTitleById result = new TitlesUpdateTitleById(id, content);
    initialize(result);
    return result;
  }

  public class TitlesUpdateTitleById extends CloudplateformdemoRequest<com.google.api.services.cloudplateformdemo.model.Title> {
     ...
     *
     * This request holds the parameters needed by the the cloudplateformdemo server.  After setting
     * any optional parameters, call the {@link TitlesUpdateTitleById#execute()} method to invoke the
     * remote operation. <p> {@link TitlesUpdateTitleById#initialize(com.google.api.client.googleapis.
     ...
     * @since 1.13
     */
    protected TitlesUpdateTitleById(java.lang.String id, com.google.api.services.cloudplateformdemo.model.Title content) {
      super(Cloudplateformdemo.this, "PUT", REST_PATH, content, com.google.api.services.cloudplateformdemo.model.Title.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
  ...
  public static final class Builder extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient.Builder {
    ...
    public Cloudplateformdemo build() {
      return new Cloudplateformdemo(this);
    }
